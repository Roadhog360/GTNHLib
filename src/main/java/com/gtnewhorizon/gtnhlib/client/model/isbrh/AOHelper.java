...
// * published by the Free Software Foundation version 2.1 of the License. This library is distributed in the hope that
// it
...
public class AOHelper {
    ...
    public static float getDirShading(ForgeDirection dir) {
        if (dir.ordinal() < 6) {
            return LIGHTNESS[dir.ordinal()];
        }
        throw new IllegalArgumentException("Unknown face " + dir + "!");
    }
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setBrightnessOverride(int brightness) {
        hasBrightnessOverride = true;
        brightnessOverride = brightness;
        return this;
    }

    public AOHelper setColorOverride(short[] color) {
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setColorOverride(int color) {
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setLightnessOverride(float lightness) {
     ...
     */
    public AOHelper setupLighting(Block block, int x, int y, int z, ForgeDirection facing) {
    ...
    /**
     * Sets up lighting for the West face and returns the {@link AOHelper}.
     * <p>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingXNeg(Block block, int x, int y, int z) {
    ...
    /**
     * Sets up lighting for the East face and returns the {@link AOHelper}.
     * <p>
     * This is a consolidated <code>method</code> that sets side shading with respect to the following attributes:
     * <p>
     * <ul>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingXPos(Block block, int x, int y, int z) {
    ...
    /**
     * Sets up lighting for the bottom face and returns the {@link AOHelper}.
     * <p>
     * This is a consolidated <code>method</code> that sets side shading with respect to the following attributes:
     * <p>
     * <ul>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingYNeg(Block block, int x, int y, int z) {
    ...
    /**
     * Sets up lighting for the top face and returns the {@link AOHelper}.
     * <p>
     * This is a consolidated <code>method</code> that sets side shading with respect to the following attributes:
     * <p>
     * <ul>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingYPos(Block block, int x, int y, int z) {
    ...
    /**
     * Sets up lighting for the North face and returns the {@link AOHelper}.
     * <p>
     * This is a consolidated <code>method</code> that sets side shading with respect to the following attributes:
     * <p>
     * <ul>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingZNeg(Block block, int x, int y, int z) {
    ...
    /**
     * Sets up lighting for the South face and returns the {@link AOHelper}.
     * <p>
     * This is a consolidated <code>method</code> that sets side shading with respect to the following attributes:
     * <p>
     * <ul>
     ...
     * @return the {@link AOHelper}
     */
    public AOHelper setupLightingZPos(Block block, int x, int y, int z) {
